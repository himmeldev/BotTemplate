...
export class Command {
	...
	constructor(data: { name: string; aliases?: string[]; description?: string; cooldown?: { type: "none" | "user" | "guild"; time?: string }; usage?: string; examples?: string; category: string; run: RunCommand }) {
